...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://m.youtube.com/channel/UCwgUQYqGjU_2e_vRGsXbyDQ')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mJAM-SALMAN\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mSalman-KHAN-Sallu\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mSallu X Hassam start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════💥══════════════════►" 
		...
		try:
			...
			if 'access_token' in q:
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mSaLLu-Checkpoint'
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mJAM-Sallu\033[;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Sk-Creation--•◈•---»" #Dev:Jam
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Hassam.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Sallu-x-Sk Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mShahrukh22"""
